...
def main(page: ft.Page):
    ...
    def animate_getSpeedContainer(e):
         for line in [line_01, line_02, line_03, line_04, line_05, line_06, line_07, line_08]:
             ...
             line_07.start_typing()
             getSpeedContainer.update()
             sleep(1)
             line_08.text_to_print = f"> task completed successfully\n\n>> app developer: stevens (group 10)"
             line_08.start_typing()
             getSpeedContainer.update()
             sleep(1)
    ...
    page.add(
        appTitle,
        getSpeedContainer,
        ft.IconButton(icon="play_circle_fill_outlined", on_click=animate_getSpeedContainer, icon_color="#1aff1a", icon_size=50),
    )
